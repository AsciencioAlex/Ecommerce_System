...
?>
  ...
  <table class="tablesorter" cellspacing="0"> 
		...
		<thead>  <th Colspan="9">  CodeNetOnline Warehouse Data Table </th></thead>
		<thead>
		<thead>
			</tr>
   		    <th>Check ID</th> 
...
<?php while($row = mysqli_fetch_array($result))
  ...
  <?php }mysqli_close($mysqli);?>
	...
	<div class="post">
					...
					<p>Youve done the best thing visiting our online shop</p>
					<p>Youve done the best thing visiting our online shop <a href="#" class="more" title="Read More">Read More</a></p>
					<div class="cl">&nbsp;</div>
				</div>
		</div>
		<!-- End Main -->
