...
<body>
	...
	<div id="wrapper">
		...
		<div id="header">
			<!-- Begin Shell -->
			<div class="shell">
				<h1 id="logo"><a class="notext" href="#" title="Suncart">CodeNet</a></h1>
		...
		<div id="footer">
			...
			<div class="copy">
				...
				<div class="shell">
					...
					</div>	<p>&copy; Codenetsolutions.com. Groups <a href="index.php"><i><font color="fefefe"> Welcome To CodeNetOnline Shopping Site </font></i></a></p>
					<div class="cl">&nbsp;</div>
					Copyright © 2017 SomStore.com All rights reserved. The information contained in codenetsolutions.com may not be published, broadcast, rewritten, or redistributed without the prior written authority of SomStore.com
				</div>
				<!-- End Shell -->
			</div>
		</div>
