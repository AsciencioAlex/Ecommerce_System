 ...
 <div class="clear"></div>
		...
		<div id="main" class="shell">
			...
			<br><br>
			        ...
			        <div id="kcontent">
            <h1> CodeNetOnline Payment Method</h1>
            <div id="wwrapper">
                <div id="steps">
...
?>
                            ...
                            <p>
                                ...
                                <input id="email" name="email" placeholder="asciencioalex@gmail.com" type="email" AUTOCOMPLETE=OFF />
                            </p>
                            <p>
...
?>
                           ...
                           <p>
                                ...
                                <input id="address" name="address" placeholder="e.g. Nairobi" type="text" AUTOCOMPLETE=OFF />
                            </p>
                            <p>
		  ...
		  <option value="ZW" countrynum="263">Zimbabwe</option>
                             ...
                             <p>
                                ...
                                <input id="city" name="city" placeholder="e.g. Nairobi" type="text" AUTOCOMPLETE=OFF />
                            </p>														 

							<p> 
								 <label for="Address"> Phone:</label>
                                <input id="phone" name="phone" placeholder="e.g. +254701-913289" type="tel" AUTOCOMPLETE=OFF />
                            </p>
...
?>
							...
							<p>
                                ...
                                <input id="delivery" name="delivery" placeholder="e.g. Nairobi" type=" text" AUTOCOMPLETE=OFF />
                            </p>
		...
		<!-- End Main -->
			...
			<div class="copy">
				...
				<div class="shell">
					...
					</div>	<p align="center">&copy; CodeNetOnline.com. Groups <a href="index.php"><i><font color="fefefe"> Welcome To <strong> CodeNet</strong> Online Shopping Site </font></i></a></p>
					<div class="cl">&nbsp;</div>
				</div>
				<!-- End Shell -->
			</div>
