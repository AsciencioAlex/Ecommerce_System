 ...
 <div class="clear"></div>
		...
		<div id="main" class="shell">
			...
			<div id="content">
				<div class="post">
					<h2>Welcome!</h2>
					<img src="images/logo.png" alt="Post Image" height="75" width="100"/>
				...
				<div class="post">
					...
					<h1 align="center"><font color="blue">About The Project Developer</font></h1><br>
					<h2>Developer</h2>
					<img src="images/pic.jpg" alt="Post Image" width="140" height="159" />
					<p>Ayekha Alex Asciencio. </p>
...
<!-- Begin Sidebar -->
   ...
   <input name="shout_message" id="shout_message" type="text" placeholder="Type Message Hit Enter" maxlength="100" /> 
					...
					</div>	<p align="center">&copy; Codenetsolutions.com. Groups <a href="index.php"><i><font color="fefefe"> Welcome To <strong> CodeNet</strong> Online Shopping Site </font></i></a></p>
					<div class="cl">&nbsp;</div>
				</div>
				<!-- End Shell -->
			</div>
