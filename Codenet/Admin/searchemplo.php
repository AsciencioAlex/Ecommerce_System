...
$db = "suncart"; //database name
$user = "root"; //dabases user name
$pwd = "admin123"; //password
...
$query ="SELECT * FROM employee WHERE Employee_Name LIKE '%$searchTerm%'";
...
?>
 ...
 <div id="tab1" class="tab_content">
  <table class="tablesorter" cellspacing="0"> 
			...
			<thead>  <th Colspan="7">  CodeNet Product Data Table </th></thead>
		<thead>
			</tr>
   		      <th>Check</th> 
    	      <th>Employee_ID</th>
