...
<aside id="sidebar" class="column">
	...
	<section id="main" class="column">
		...
		<h4 class="alert_info">Welcome To <strong>"CodeNetOnline"</strong> Admin Panel As: <?php echo "  ". "<font color='#f90'><big><b>".$login_session."</b></big></font>" ;?>  </h4> 
