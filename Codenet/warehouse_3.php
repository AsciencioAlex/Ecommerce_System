...
<head>
	<title> CodeNetOnline Groups </title>
...
?>
 ...
 <div class="clear"></div>
    ...
    ?>
		...
		<div id="footer">
			...
			<div class="copy">
				...
				<div class="shell">
					...
					<div class="cl">&nbsp;</div>
					Copyright © 2017 Codenetsolutions.com All rights reserved. The information contained in SomStore.com may not be published, broadcast, rewritten, or redistributed without the prior written authority of SomStore.com
				</div>
				<!-- End Shell -->
			</div>
		</div>
		...
		<div class="shout_box">
      <div class="header"> live Discussion of CodeNet <div class="close_btn">&nbsp;</div></div>
