...
<head>
	<title> CodeNetOnline Group </title>
...
<body>
	...
	<div id="wrapper">
		...
		<div id="header">
			<!-- Begin Shell -->
			<div class="shell">
				<h1 id="logo"><a class="notext" href="#" title="SomStore">CodeNet</a></h1>
				<div id="top-nav">
					<ul>
 ...
 <div class="clear"></div>
					...
					<li>
					   ...
					   <li><a href="products.php"> Products</a></li>
						...
						<div class="dd">
							<ul>
								<li>
									 <a href="warehouse_1.php">CodeNet Food Staff</a>
									
								</li>
								
								<li>
									 <a href="warehouse_2.php">CodeNet Beverages</a>
									
								</li>
								
								<li>
									<a href="warehouse_3.php">CodeNet House Staff</a>
									
								</li>
								
								<li>
									<a href="warehouse_4.php">CodeNet Clothes</a>
		...
		<div id="main" class="shell">
			...
			<div id="content">
				<div class="post">
					<h2>Welcome!</h2>
					<img src="images/logo.png" alt="Post Image" height="100" width="100"/>
					You can be confident when you're shopping online with CodeNetOnline. Our Secure online shopping website encrypts your personal and financial information to ensure your order information is protected.We use industry standard 128-bit encryption. Our Secure online shopping website locks all critical information passed from you to us,
    ...
    ?>
		...
		<div id="footer">
				...
				<div class="shell">
					<div class="box post-box">
						...
						<div class="box-entry">
							...
							<p>You can be confident when you're shopping online with CodeNetOnline. Our Secure online shopping website encrypts your personal and financial information to ensure your order information is protected.We use industry standard 128-bit encryption. Our Secure online shopping website locks all critical information passed from you to us,
			...
			<div class="copy">
				...
				<div class="shell">
					...
					</div>	<p>&copy; Codenetsolutions.com. Groups <a href="index.php"><i><font color="fefefe"> Welcome To CodeNet Online Shopping Site </font></i></a></p>
					<div class="cl">&nbsp;</div>
					Copyright © 2017 Codenetsolutions.com All rights reserved. The information contained in SomStore.com may not be published, broadcast, rewritten, or redistributed without the prior written authority of Codenetsolutions.com
				</div>
				<!-- End Shell -->
			</div>
		</div>
		...
		<div class="shout_box">
      <div class="header"> live Discussion of CodeNetOnline <div class="close_btn">&nbsp;</div></div>
