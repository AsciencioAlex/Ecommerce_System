		...
		<div id="footer">
			<div class="boxes">
				...
				<div class="shell">
					<div class="box post-box">
						...
						<div class="box-entry">
							<img src="images/logo.png" alt="SomStore" width="100" height="80"/>
			...
			<div class="copy">
				...
				<div class="shell">
					...
					<div class="cl">&nbsp;</div>
					Copyright © 2017 Codenetsolutions.com All rights reserved. The information contained in codenetsolutions.com may not be published, broadcast, rewritten, or redistributed without the prior written authority of SomStore.com
				</div>
				<!-- End Shell -->
			</div>
		</div>
