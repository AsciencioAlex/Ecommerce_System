...
<body>
	...
	<div id="wrapper">
		...
		<div id="header">
			<!-- Begin Shell -->
			<div class="shell">
				<h1 id="logo"><a class="notext" href="#" title="Suncart">CodeNetOnline</a></h1>
				<div id="top-nav">
					<ul>
				...
				<div class="shell">
					<div class="box post-box">
						...
						<div class="box-entry">
							...
							<p>You can be confident when you're shopping online with CodeNet. Our Secure online shopping website encrypts your personal and financial information to ensure your order information is protected.We use industry standard 128-bit encryption. Our Secure online shopping website locks all critical information passed from you to us,
